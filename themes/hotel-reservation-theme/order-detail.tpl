                                    ...
                                    <dl class="">
                                        <div class="row">
                                            ...
                                            <dd class="col-xs-6 col-sm-3">
                                                <a
                                                    href="tel:{if $hotel_address_info.phone_mobile}{$hotel_address_info.phone_mobile}{else}{$hotel_address_info.phone}{/if}">
                                            ...
                                            <dd class="col-xs-6 col-sm-3">
                                                <a href="mailto:{$obj_hotel_branch_information->email}"
                                                    class="hotel-email">{$obj_hotel_branch_information->email}</a>
                                            </dd>
                            ...
                            <div class="detail-row">
                                ...
                                <div class=" value payment-method">
                                    {if $invoice && $invoiceAllowed}
                                        ...
                                        <a target="_blank"
                                            href="{$link->getPageLink('pdf-invoice', true)}?id_order={$order->id|intval}{if $is_guest}&amp;secure_key={$order->secure_key|escape:'html':'UTF-8'}{/if}"
                                            title="{l s='Click here to download invoice.'}">
                            ...
                            <div class="detail-row">
                                ...
                                <div class="pull-right value status">
                                    {if isset($order_history[0]) && $order_history[0]}
                                        <span{if isset($order_history[0].color) && $order_history[0].color}
                                                style="background-color:{$order_history[0].color|escape:'html':'UTF-8'}30; border: 1px solid {$order_history[0].color|escape:'html':'UTF-8'};"
                                            {/if} class="label">
                    ...
                    {if isset($refundReqBookings) && $refundReqBookings}
                        <div class="alert alert-info-light cancel_requests_link_wrapper">
                            ...
                            {if count($refundReqBookings) <= 1}
                                <span>{l s='Your cancellation request for 1 room is being processed. To check request status'} <a
                                        target="_blank"
                                        href="{$link->getPageLink('order-follow')|escape:'html':'UTF-8'}?id_order={$order->id|escape:'html':'UTF-8'}">{l s='click here.'}</a>
                                {else}
                                    <span>{l s='Your cancellation request for %d rooms is being processed. To check request statuses' sprintf=[count($refundReqBookings)]}
                                        <a target="_blank"
                                            href="{$link->getPageLink('order-follow')|escape:'html':'UTF-8'}?id_order={$order->id|escape:'html':'UTF-8'}">{l s='click here.'}</a>
                                    {/if}
                        </div>
                                    ...
                                    <div class="col-xs-12 clearfix">
                                        {if $refund_allowed}
                                            {if !$completeRefundRequestOrCancel}
                                                <a id="order_refund_request" class="btn btn-default pull-right" href="#"
                                                    title="{l s='Proceed to refund'}"><span>{l s='Cancel Bookings'}</span></a>
                                            {/if}
                                            {if isset($id_cms_refund_policy) && $id_cms_refund_policy}
                                                <a target="_blank" class="btn btn-default pull-right refund_policy_link"
                                                    href="{$link->getCMSLink($id_cms_refund_policy)|escape:'html':'UTF-8'}">{l s='Refund Policies'}</a>
                                            {/if}
                                        {/if}
                                    ...
                                    <tbody>
                                        ...
                                        {if $priceDisplay && $use_tax && $room_price_tax_excl}
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <span
                                                        class="price">{displayWtPriceWithCurrency price=($room_price_tax_excl + $additional_service_price_tax_excl - $total_convenience_fee_te) currency=$currency}</span>
                                                </td>
                                            </tr>
                                        {else}
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <span
                                                        class="price">{displayWtPriceWithCurrency price=($room_price_tax_incl + $additional_service_price_tax_incl - $total_convenience_fee_ti) currency=$currency}</span>
                                                </td>
                                            </tr>
                                        {/if}
                                        ...
                                        {if $priceDisplay && $use_tax && $total_convenience_fee_te}
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <span
                                                        class="price">{displayWtPriceWithCurrency price=$total_convenience_fee_te currency=$currency}</span>
                                                </td>
                                            </tr>
                                        {else if $total_convenience_fee_ti}
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <span
                                                        class="price">{displayWtPriceWithCurrency price=$total_convenience_fee_ti currency=$currency}</span>
                                                </td>
                                            </tr>
                                        {/if}
                                        ...
                                        <tr class="totalprice item">
                                            ...
                                            <td class="text-right">
                                                <span
                                                    class="price">{displayWtPriceWithCurrency price=($total_tax_without_discount) currency=$currency}</span>
                                            </td>
                                        </tr>
                                        ...
                                        {if $order->total_discounts > 0}
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <span
                                                        class="price price-discount">-{displayWtPriceWithCurrency price=$order->total_discounts currency=$currency convert=1}</span>
                                                </td>
                                            </tr>
                                        {/if}
                                        <tr class="totalprice item">
                                            ...
                                            <td class="text-right">
                                                <strong><span
                                                        class="price">{displayWtPriceWithCurrency price=$order->total_paid currency=$currency}</span></strong>
                                            </td>
                                        </tr>
                                        ...
                                        {if isset($refundReqBookings) && $refundReqBookings}
                                            <tr class="totalprice item">
                                                ...
                                                <td class="text-right">
                                                    <span
                                                        class="price">{displayWtPriceWithCurrency price=$refundedAmount currency=$currency}</span>
                                                </td>
                                            </tr>
                                        {/if}
                                        ...
                                        {if $order->total_paid_tax_incl > $order->total_paid_real}
                                            <tr class="totalprice item">
                                                ...
                                                <td class="text-right">
                                                    <span
                                                        class="price">{displayWtPriceWithCurrency price=($order->total_paid_tax_incl - $order->total_paid_real) currency=$currency}</span>
                                                </td>
                                            </tr>
                                        {/if}
                                    ...
                                    <tbody>
                                        {if $customerGuestDetail}
                                            {if isset($customerGuestDetail->firstname) && $customerGuestDetail->firstname}
                                                <tr>
                                                    <td>{l s='Name'}</td>
                                                    <td class="text-right">{$customerGuestDetail->firstname|escape:'html':'UTF-8'}
                                                        {$customerGuestDetail->lastname|escape:'html':'UTF-8'}</td>
                                                </tr>
                                            {/if}
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    {elseif isset($guestInformations['firstname']) && $guestInformations['firstname']}
                                                        {$guestInformations['firstname']|escape:'html':'UTF-8'}
                                                        {$guestInformations['lastname']|escape:'html':'UTF-8'}
                                                    {/if}
                                                </td>
                                            </tr>
                                            ...
                                            <div class="refund-policies-list">
                                                {foreach from=$hotel_refund_rules item=hotel_refund_rule name=foreach_refund_rules}
                                                    <div class="refund-policy">
                                                        <p class="refund-rule-name">
                                                            {l s='%s. ' sprintf=[$smarty.foreach.foreach_refund_rules.iteration]}{$hotel_refund_rule.name|escape:'html':'UTF-8'}
                                                        </p>
                                                        <div class="card-text refund-rule-description">
                                                            {$hotel_refund_rule.description|escape:'html':'UTF-8'}</div>
                                                    </div>
                                                {/foreach}
                                            </div>
                                        </div>
                        ...
                        <div class="card add-order-message" id="add-order-message">
                            ...
                            <div class="card-body">
                                ...
                                {block name='order_detail_add_order_messages_form'}
                                    <form action="{$link->getPageLink('order-detail', true)|escape:'html':'UTF-8'}" method="post"
                                        class="std" id="sendOrderMessage">
                                        ...
                                        <div class="submit">
                                            ...
                                            <button type="submit" name="submitMessage" id="submitMessage"
                                                class="button btn button-medium"><span>{l s='Send'}</span></button>
                                        </div>
                                    </form>
                                {/block}
                            </div>
            ...
            <div class="row">
                <div class="col-sm-8">
                    <p class="alert alert-info"><i class="icon-info-sign"></i>
                        {l s='You cannot request refund with a guest account.'}</p>
                </div>
            </div>
        {/if}
                                        ...
                                        <div class="row no-gutters">
                                                    ...
                                                    {foreach from=$cart_htl_data key=data_k item=data_v}
                                                        {foreach from=$data_v['date_diff'] key=rm_k item=rm_v}
                                                            ...
                                                            <li class="{if $flag_is_first_iteration}active{/if}">
                                                                <a href="#room-info-tab-{$data_v.id_product}-{$rm_k}" class=""
                                                                    data-toggle="tab">
                                                                    <div class="room-type-name">{$data_v.name}</div>
                                                                    <div class="duration">{dateFormat date=$rm_v.data_form full=$is_full_date} -
                                                                        {dateFormat date=$rm_v.data_to full=$is_full_date}</div>
                                                                </a>
                                                            </li>
                                            ...
                                            <div class="col-xs-8">
                                                <div class="tab-content clearfix">
                                                    ...
                                                    {foreach from=$cart_htl_data key=data_k item=data_v}
                                                        {foreach from=$data_v['date_diff'] key=rm_k item=rm_v}
                                                            <div id="room-info-tab-{$data_v.id_product}-{$rm_k}"
                                                                class="tab-pane {if $flag_is_first_iteration}active{/if}">
                                                                ...
                                                                <div class="rooms-summary">
                                                                    {foreach from=$rm_v['hotel_booking_details'] item=$hotel_booking_detail name=foreachRefundRooms}
                                                                        ...
                                                                        <div
                                                                            class="room-details {if $is_room_cancelled || ($hotel_booking_detail.id_status != $ROOM_STATUS_ALLOTED)}cancelled{/if} clearfix">
                                                                            <div class="occupancy-wrap">
                                                                                <div class="checkbox">
                                                                                    <label
                                                                                        for="bookings_to_refund_{$hotel_booking_detail.id_htl_booking}">
                                                                                        <input type="checkbox" class="bookings_to_refund"
                                                                                            id="bookings_to_refund_{$hotel_booking_detail.id_htl_booking}"
                                                                                            name="bookings_to_refund[]"
                                                                                            value="{$hotel_booking_detail.id_htl_booking|escape:'html':'UTF-8'}"
                                                                                            {if $is_room_cancelled || ($hotel_booking_detail.id_status != $ROOM_STATUS_ALLOTED)}disabled{/if} />
                                                                                        {l s='Room'} -
                                                                                        {$smarty.foreach.foreachRefundRooms.iteration|string_format:'%02d'}
                                                                                    </label>

                                                                                    <span>({$hotel_booking_detail.adults|string_format:'%02d'}
                                                                                        {if $hotel_booking_detail.adults > 1}{l s='Adults'}{else}{l s='Adult'}{/if}{if $hotel_booking_detail.children > 0}{l s=', '}{$hotel_booking_detail.children|string_format:'%02d'}
                                                                                        {if $hotel_booking_detail.children > 1}{l s='Children'}{else}{l s='Child'}{/if}{/if})</span>
                                                                                    {if $hotel_booking_detail.is_cancelled}<span
                                                                                        class="badge badge-danger badge-cancelled">{l s='Cancelled'}</span>{else if $hotel_booking_detail.is_refunded}<span
                                                                                        class="badge badge-danger badge-cancelled">{l s='Refunded'}</span>{else if $hotel_booking_detail.refund_denied}<span
                                                                                            class="badge badge-danger badge-cancelled">{l s='Refund denied'}</span>
                                                                                        <i class="icon-info-circle refund-denied-info"
                                                                                        data-refund_denied_info="{l s='Refund for this booking is denied. Please contact admin for more detail.'}"></i>{else if $hotel_booking_detail.id_status != $ROOM_STATUS_ALLOTED}<span
                                                                                            class="badge badge-danger badge-cancelled">{if $hotel_booking_detail.id_status == $ROOM_STATUS_CHECKED_OUT}{l s='Checked-Out'}{else}{l s='Checked-In'}{/if}</span>{/if}
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                {else}
                                                                                    <div class="extra-services-wrap clearfix">
                                                                                        <p class="text-muted">{l s='No extra services added for this room.'}
                                                                                        </p>
                                                                                    </div>
                                                                                {/if}
                                                                            </div>
                                ...
                                <div class="card cancel-booking-preview" style="display:none;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="well well-sm">
                                            <p class="text">{l s='Total Rooms to Cancel:'} <span class="count-total-rooms">{l s='00'}</span>
                                            </p>
                                        </div>

                                        <div class="form-group">
                                            <label class="label">{l s='Mention reason for cancellation'}<sup>{l s='*'}</sup></label>
                                            <textarea class="form-control cancellation_reason" name="cancellation_reason" rows="4"
                                                placeholder="{l s='Type here...'}"></textarea>
                                        </div>
                                    </div>
                    ...
                    <div id="popup-cancellation-submit-success" class="popup-cancellation-submit-success" style="display: none;">
                        <div class="card">
                            <div class="text-center">
                                ...
                                <h4>{l s='Your cancellation request has been submitted successfully. Go to Booking Refund Requests page for further updates.'}
                                </h4>
                            </div>
                        </div>
                    </div>
